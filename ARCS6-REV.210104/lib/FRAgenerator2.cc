...
#include <cmath>
#include "FRAgenerator2.hh"
#include "ARCSeventlog.hh"

using namespace ARCS;

//! @brief コンストラクタ
FRAgenerator2::FRAgenerator2(
	...
	: fmin(FreqMin), fmax(FreqMax), fstep(FreqStep), Ni(NumIntg), Tsta(TimeSta),
...
std::tuple<double, double> FRAgenerator2::GetSignal(double Au, double Bu, double t){
