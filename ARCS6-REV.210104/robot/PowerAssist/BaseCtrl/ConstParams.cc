...
const std::array<std::string, ConstParams::PLOT_MAX> ConstParams::PLOT_FLABEL = {
	"Force [N]",	// プロット0
	"Moment [Nm]",	// プロット1
	"R Velocity [m/s]",	// プロット2
	"L Velocity [m/s]",	// プロット3
	"---------- [-]",	// プロット4
	"---------- [-]",	// プロット5
	"---------- [-]",	// プロット6
	"---------- [-]",	// プロット7
...
> ConstParams::PLOT_VAR_NAMES = {{
	{"Fsen", "Fdis", "Fz", "VAR-03", "VAR-04", "VAR-05", "VAR-06", "VAR-07",},	// プロット0
	{"CurrentRef", "My", "Mz", "VAR-03", "VAR-04", "VAR-05", "VAR-06", "VAR-07",},	// プロット1
	{"Position", "VelocityRes", "VAR-02", "VAR-03", "VAR-04", "VAR-05", "VAR-06", "VAR-07",},	// プロット2
	{"Velocity", "VResL", "VAR-02", "VAR-03", "VAR-04", "VAR-05", "VAR-06", "VAR-07",},	// プロット3
